    ...
    config.set(
        {
            ...
            files: [
                ...
                'dist/izi-js-jquery.min.js',
                'test/runner/sinon-1.3.1.js',
                'test/runner/jasmine-sinon.js',
                'test/runner/toThrowContaining-matcher.js',
                ...
                {pattern: 'node_modules/jquery/dist/*', watched: true, included: false, served: true}
            ],
